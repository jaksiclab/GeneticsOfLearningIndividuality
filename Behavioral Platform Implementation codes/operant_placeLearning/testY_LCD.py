...
all_cool = input(
    "Check if both the power button on the powersupply is turned on (press enter to continue...)"
)
all_cool = input(
...
os.system('start py "' + utilities_wd + '/keep_me_up.py"')
all_cool = input(
...
os.system('py "' + utilities_wd + '/getBoxes_aruco_64.py"')
...
noShockControl_choice = input("Keep no shock controls (33 - 64) [y/n]: ")
...
for i in range(n):
    ...
    obj.shockArm = str(initial_config[i][1])
